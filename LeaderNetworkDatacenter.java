 ...
 */
public class LeaderNetworkDatacenter extends Datacenter {
	 ...
	 * @post $none
	 */
	public LeaderNetworkDatacenter(
			String name,
		...
		Switchlist = new HashMap<Integer, LeaderSwitch>();
	}
	...
	public Map<Integer, LeaderSwitch> Switchlist;
	 ...
	 * 
	 */
	public Map<Integer, LeaderSwitch> getEdgeSwitch() {
		Map<Integer, LeaderSwitch> edgeswitch = new HashMap<Integer, LeaderSwitch>();
		for (Entry<Integer, LeaderSwitch> es : Switchlist.entrySet()) {
	...
	public boolean processVmCreateNetwork(Vm vm) {
		...
		if (result) {
			VmToSwitchid.put(vm.getId(), ((LeaderNetworkHost) vm.getHost()).sw.getId());
			...
			System.out.println("Vm is created in processVmCreateNetwork of networkDatacenter");
