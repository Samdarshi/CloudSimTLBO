 ...
 */
public class IBOEdgeSwitch extends IBOSwitch {
	 ...
	 */
	public IBOEdgeSwitch(String name, int level, IBONetworkDatacenter dc) {
		super(name, level, dc);
		hostlist1 = new HashMap<Integer, IBONetworkHost>();
		...
		uplinkswitches = new ArrayList<IBOSwitch>();
	}
