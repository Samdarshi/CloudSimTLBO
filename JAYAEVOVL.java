...
public class JAYAEVOVL {
	public JAYAEVOVL(double[][] td, double[] et, Datacenter dc, int dim)
	{
	...
	public ArrayList<Integer> runJAYA()
	{
		// Create a swarm (using 'MyParticle' as sample particle and 'MyFitnessFunction' as fitness function)
		Population pop = new Population(20,//Swarm.DEFAULT_NUMBER_OF_PARTICLES, 
				               new JAYAPArticle(workFlowTaskExecution.length/*10*/), 
				               new JAYAMyFItness(workFlowDataTrans, workFlowTaskExecution, vmData, vmTransferCost),Dim);
