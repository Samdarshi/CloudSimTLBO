 ...
 */
public class IBONetworkDatacenter extends Datacenter {
	...
	public IBONetworkDatacenter(
		...
		Switchlist = new HashMap<Integer, IBOSwitch>();
	}
	...
	public Map<Integer, IBOSwitch> Switchlist;
	 ...
	 * 
	 */
	public Map<Integer, IBOSwitch> getEdgeSwitch() {
		Map<Integer, IBOSwitch> edgeswitch = new HashMap<Integer, IBOSwitch>();
		for (Entry<Integer, IBOSwitch> es : Switchlist.entrySet()) {
	...
	public boolean processVmCreateNetwork(Vm vm) {
		...
		if (result) {
			VmToSwitchid.put(vm.getId(), ((IBONetworkHost) vm.getHost()).sw.getId());
