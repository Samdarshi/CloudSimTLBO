...
import IBO_pkg.IBOPOPulation;

public class IBO {
	public IBO(double[][] td, double[] et, Datacenter dc, int dim)
	{
	...
	public ArrayList<Integer> runIBO()
	{
		// Create a swarm (using 'MyParticle' as sample particle and 'MyFitnessFunction' as fitness function)
		IBOPOPulation pop = new IBOPOPulation(20,//Swarm.DEFAULT_NUMBER_OF_PARTICLES, 
				               new IBOParticle(workFlowTaskExecution.length/*10*/), 
				               new IBOMyFitness(workFlowDataTrans, workFlowTaskExecution, vmData, vmTransferCost),Dim);
