 ...
 */
public class TLBONetworkDatacenter extends Datacenter {
	...
	public TLBONetworkDatacenter(
		...
		Switchlist = new HashMap<Integer, TLBOSwitch>();
	}
	...
	public Map<Integer, TLBOSwitch> Switchlist;
	 ...
	 * 
	 */
	public Map<Integer, TLBOSwitch> getEdgeSwitch() {
		Map<Integer, TLBOSwitch> edgeswitch = new HashMap<Integer, TLBOSwitch>();
		for (Entry<Integer, TLBOSwitch> es : Switchlist.entrySet()) {
	...
	public boolean processVmCreateNetwork(Vm vm) {
		...
		if (result) {
			VmToSwitchid.put(vm.getId(), ((TLBONetworkHost) vm.getHost()).sw.getId());
