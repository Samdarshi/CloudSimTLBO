 ...
 */
public class IBONetworkVmAllocationPolicy extends VmAllocationPolicy {
	 ...
	 * @post $none
	 */
	public IBONetworkVmAllocationPolicy(List<? extends Host> list) {
		super(list);
	...
	public boolean allocateHostForVm(Vm vm) {
		...
		if (!getVmTable().containsKey(vm.getUid())) { // if this vm was not created
			do {// we still trying until we find a host or until we try all of them
				...
				IBONetworkHost host = this.<IBONetworkHost> getHostList().get(idx);
