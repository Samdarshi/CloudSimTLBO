 ...
 */
public class JAYANetworkDatacenter extends Datacenter {
	...
	public JAYANetworkDatacenter(
		...
		Switchlist = new HashMap<Integer, JAYASwitch>();
	}
	...
	public Map<Integer, JAYASwitch> Switchlist;
	 ...
	 * 
	 */
	public Map<Integer, JAYASwitch> getEdgeSwitch() {
		Map<Integer, JAYASwitch> edgeswitch = new HashMap<Integer, JAYASwitch>();
		for (Entry<Integer, JAYASwitch> es : Switchlist.entrySet()) {
	...
	public boolean processVmCreateNetwork(Vm vm) {
		...
		if (result) {
			VmToSwitchid.put(vm.getId(), ((JAYANetworkHost) vm.getHost()).sw.getId());
